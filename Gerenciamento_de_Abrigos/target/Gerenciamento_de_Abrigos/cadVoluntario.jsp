    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Gerenciar Voluntários</a>
                </li>
                <li class="nav-item">
                ...
                <tr>
                    ...
                    <td>
                        <c:if test="${ab.vagas > 0}">
                            <a class="btn btn-primary" href="http://localhost:8080/Gerenciamento_de_Abrigos/VoluntarioController?abrigoid=${ab.id_abrigo}"> Selecionar abrigo </a>
                        </c:if>
                        <c:if test="${ab.vagas == 0}">
